...
#Run CEMITool
cem.tmm.children <- cemitool(tmm.counts.children, smpl.annot[smpl.annot$Class=="Children",])
...
cem.tmm.elderly <- cemitool(tmm.counts.elderly, smpl.annot[smpl.annot$Class=="Elderly",])
diagnostic_report(cem.tmm.elderly, directory = "./Reports/Diagnostics_elderly")
